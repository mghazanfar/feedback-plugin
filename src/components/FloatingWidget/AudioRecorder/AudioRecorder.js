  ...
  render() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <Text allowFontScaling={false} style={styles.titleTxt}>Audio Recorder Player</Text>
        <Text allowFontScaling={false} style={styles.txtRecordCounter}>{this.state.recordTime}</Text>
